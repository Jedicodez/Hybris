 ...
 */
package de.hybris.kiranacommercewebservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import de.hybris.kiranacommercewebservices.constants.YcommercewebservicesConstants;
import de.hybris.kiranacommercewebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "kiranacommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "kiranacommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "kiranacommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "kiranacommercewebservices.v2.description";
	private static final String TITLE = "kiranacommercewebservices.v2.title";
	private static final String VERSION = "kiranacommercewebservices.v2.version";
	private static final String LICENSE = "kiranacommercewebservices.v2.license";
	private static final String LICENSE_URL = "kiranacommercewebservices.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "kiranacommercewebservices.content.negotiation.legacy";
