...
import org.saass.constants.SaassConstants;
 ...
 */
public class SaassManager extends GeneratedSaassManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SaassManager.class.getName());
	 ...
	 */
	public static SaassManager getInstance()
	{
		return (SaassManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SaassConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SaassManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SaassManager called.");
		}
	}
