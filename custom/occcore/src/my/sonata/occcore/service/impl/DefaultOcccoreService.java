...
public class DefaultOcccoreService implements OcccoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultOcccoreService.class);
	...
	{
		return DefaultOcccoreService.class.getResourceAsStream("/occcore/sap-hybris-platform.png");
	}
