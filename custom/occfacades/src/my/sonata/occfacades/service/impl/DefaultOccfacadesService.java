...
public class DefaultOccfacadesService implements OccfacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultOccfacadesService.class);
	...
	{
		return DefaultOccfacadesService.class.getResourceAsStream("/occfacades/sap-hybris-platform.png");
	}
