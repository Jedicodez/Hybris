...
import de.hybris.myshoestore.core.jalo.CustomBannersComponent;
import de.hybris.myshoestore.core.jalo.ElectronicsColorVariantProduct;
import de.hybris.myshoestore.core.jalo.PremiumCustomer;
import de.hybris.myshoestorecore.jalo.Gadget;
...
public abstract class GeneratedMyshoestoreCoreManager extends Extension
{
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.colour</code> attribute.
	 * @return the colour - Size of the Product
	 */
	public String getColour(final SessionContext ctx, final Product item)
	{
		return (String)item.getProperty( ctx, MyshoestoreCoreConstants.Attributes.Product.COLOUR);
	}
	 ...
	 * @return the colour - Size of the Product
	 */
	public String getColour(final Product item)
	{
		return getColour( getSession().getSessionContext(), item );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>Product.colour</code> attribute. 
	 * @param value the colour - Size of the Product
	 */
	public void setColour(final SessionContext ctx, final Product item, final String value)
	{
		item.setProperty(ctx, MyshoestoreCoreConstants.Attributes.Product.COLOUR,value);
	}
	 ...
	 * @param value the colour - Size of the Product
	 */
	public void setColour(final Product item, final String value)
	{
		setColour( getSession().getSessionContext(), item, value );
	}
	...
	public Cookies createCookies(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( MyshoestoreCoreConstants.TC.COOKIES );
			return (Cookies)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating Cookies : "+e.getMessage(), 0 );
		}
	}
	
	public Cookies createCookies(final Map attributeValues)
	{
		return createCookies( getSession().getSessionContext(), attributeValues );
	}
	
	public CustomBannersComponent createCustomBannersComponent(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( MyshoestoreCoreConstants.TC.CUSTOMBANNERSCOMPONENT );
			return (CustomBannersComponent)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating CustomBannersComponent : "+e.getMessage(), 0 );
		}
	}
	
	public CustomBannersComponent createCustomBannersComponent(final Map attributeValues)
	{
		return createCustomBannersComponent( getSession().getSessionContext(), attributeValues );
	}
	...
	public Gadget createGadget(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( MyshoestoreCoreConstants.TC.GADGET );
			return (Gadget)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating Gadget : "+e.getMessage(), 0 );
		}
	}
	
	public Gadget createGadget(final Map attributeValues)
	{
		return createGadget( getSession().getSessionContext(), attributeValues );
	}
	
	public PremiumCustomer createPremiumCustomer(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( MyshoestoreCoreConstants.TC.PREMIUMCUSTOMER );
			return (PremiumCustomer)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating PremiumCustomer : "+e.getMessage(), 0 );
		}
	}
	
	public PremiumCustomer createPremiumCustomer(final Map attributeValues)
	{
		return createPremiumCustomer( getSession().getSessionContext(), attributeValues );
	}
