...
/**
 * Generated class for type {@link de.hybris.myshoestore.core.jalo.CustomBannersComponent CustomBannersComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedCustomBannersComponent extends SimpleCMSComponent
{
	/** Qualifier of the <code>CustomBannersComponent.headrerText</code> attribute **/
	public static final String HEADRERTEXT = "headrerText";
	/** Qualifier of the <code>CustomBannersComponent.footerText</code> attribute **/
	public static final String FOOTERTEXT = "footerText";
	/** Qualifier of the <code>CustomBannersComponent.bannerImage</code> attribute **/
	public static final String BANNERIMAGE = "bannerImage";
	/** Qualifier of the <code>CustomBannersComponent.offerImageLink</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CustomBannersComponent.bannerImage</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>CustomBannersComponent.bannerImage</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CustomBannersComponent.footerText</code> attribute.
	...
	public String getFooterText(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedCustomBannersComponent.getFooterText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>CustomBannersComponent.footerText</code> attribute. 
	...
	public void setFooterText(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedCustomBannersComponent.setFooterText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CustomBannersComponent.headrerText</code> attribute.
	...
	public String getHeadrerText(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedCustomBannersComponent.getHeadrerText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>CustomBannersComponent.headrerText</code> attribute. 
	...
	public void setHeadrerText(final SessionContext ctx, final String value)
	{
		...
		if( ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedCustomBannersComponent.setHeadrerText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CustomBannersComponent.offerImageLink</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>CustomBannersComponent.offerImageLink</code> attribute. 
