...
public class GeneratedMyshoestoreCoreConstants
{
	...
	public static class TC
	{
		...
		public static final String COOKIES = "Cookies".intern();
		public static final String CUSTOMBANNERSCOMPONENT = "CustomBannersComponent".intern();
		public static final String ELECTRONICSCOLORVARIANTPRODUCT = "ElectronicsColorVariantProduct".intern();
		public static final String GADGET = "Gadget".intern();
		public static final String PREMIUMCUSTOMER = "PremiumCustomer".intern();
