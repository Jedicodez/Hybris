...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms // NOSONAR
		{
			...
			String CustomBannersComponent = _Prefix + CustomBannersComponentModel._TYPECODE + _Suffix;
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			interface Product // NOSONAR
			{
				...
				String PremiumCustomerDetails = "pages/product/premiumCustomerDetails";

				String CookiesDetails = "pages/product/cookiesPage";
                String CreateCookies = "pages/product/createCookiesPage";
                String UpdateCookies = "pages/product/updateCookiesPage";
            }
