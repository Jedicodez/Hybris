...
public class DefaultMyCronJobService implements MyCronJobService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMyCronJobService.class);
	...
	{
		return DefaultMyCronJobService.class.getResourceAsStream("/myCronJob/sap-hybris-platform.png");
	}
